...
import ImgCreateIssue from '@site/static/img/create-issue.png'
...
In the [Data Explorer](/docs/data-explorer/data-explorer), check a row checkbox and click `Create Issue`.

<img style={{marginLeft:'15px', marginBottom: '5px', height: '100px'}} src={ImgCreateIssue} />
